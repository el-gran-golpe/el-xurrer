...
VOICE_SOURCES = {
    PERRO_SANXE: {
        AUDIO_PATH: os.path.join(
            os.path.dirname(__file__), "source_voices", "perro_sanxe.wav"
        ),
    ...
    LOLI: {
        AUDIO_PATH: os.path.join(
            os.path.dirname(__file__), "source_voices", "english_loli.wav"
        ),
    ...
    MISTERIOUS_VOICE: {
        AUDIO_PATH: os.path.join(
            os.path.dirname(__file__), "source_voices", "misterious_voice.wav"
        ),
    ...
    MISTERIOUS_VOICE_ENGLISH: {
        AUDIO_PATH: os.path.join(
            os.path.dirname(__file__), "source_voices", "misterious_voice_english.wav"
        ),
    ...
    NOELLE: {
        AUDIO_PATH: os.path.join(
            os.path.dirname(__file__), "source_voices", "noelle.wav"
        ),
