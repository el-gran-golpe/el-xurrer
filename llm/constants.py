...
VALIDATION_SYSTEM_PROMPT = (
    "You are a categorization assistant tasked with analyzing the finish_reason "
...
# When creating a `pro_file.json` profile, ensure any trigger words used are also added to HOT_KEYWORDS below.
