...
def test_plan_commands_expose_refresh_model_cache_flag():
    commands = [
        ("mains/commands/meta.py", "plan"),
        ("mains/commands/fanvue.py", "plan"),
        ("mains/commands/all.py", "run_all"),
        ("mains/commands/all.py", "debug"),
    ]
...
def test_refresh_model_cache_flag_reaches_planning_pipeline():
    pipeline_plan = _function_def("mains/commands/pipeline.py", "plan")
    planning_manager_init = _function_def(
        "main_components/planning_manager.py", "__init__"
    )
    execute_all = _function_def("mains/commands/all.py", "_execute_all")
